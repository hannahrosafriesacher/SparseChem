...
for k in range(10):
    ...
    k+=1
#print('--------------------------------------')
#print('Num of actives in Test Fold:', np.sum(NumPos), 'Num of inactives in Test Fold:', np.sum(NumNeg))
#print(clas)
...
#save figure
plt.savefig('./ProbCal_plots/BoxPlot_Count and_PositiveRate_TargetID'+str(TargetID)+'_'+str(date)+'Large_Chembl_29_PubChem.png')
