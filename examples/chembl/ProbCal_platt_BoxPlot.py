...
for j in range(10):
    #print(split(y_hat_platt, np.logical_and(y_hat_platt>=values[j], y_hat_platt<values[j+1])))
...
fig.tight_layout()
plt.savefig('./ProbCal_plots/BoxPlot_Count and_PositiveRate_TargetID_plattScaling'+str(TargetID)+'_'+str(date)+'.pdf')
